...
const Navbar = () => {
    ...
    return (
        <nav className='flex items-center justify-between py-6 px-4 sm:px-[3vw] md:px-[4vw] lg:px-[5vw] font-medium border-b border-[#e5e5e5] bg-[#fcfbf9] relative w-full z-50'>
